      ...
      >
        ...
        <div className="flex flex-col h-screen w-full items-center justify-center p-10">
          <div className="flex flex-col gap-10 items-center justify-center z-10 ">
            ...
            <h1 className="font-semibold text-4xl sm:text-5xl md:text-7xl z-10 text-center font-michroma-base fade-slide-left bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">
