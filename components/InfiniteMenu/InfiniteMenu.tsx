    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-stretch pointer-events-none z-20">
            <div className="flex flex-row justify-between items-center w-full px-[5vw] ">
              {/* Title */}
              <h2
                className={`
            select-none
            text-gold
            text-[1rem] md:text-[1.4rem] lg:text-[1.8rem]
            font-michroma-base
          ...
          `}
                style={{ maxWidth: "28vw", textAlign: "center" }}
              >
                {activeItem.title}
              </h2>
            ...
            select-none
            max-w-[16ch]
            text-[0.6rem] md:text-[0.9rem] lg:text-[1rem]
            font-sora-base
            text-center
            leading-snug
            text-white
          ...
          <div
            ...
            ${
              isMoving
                ...
                : "bottom-[6.8em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2"
            }
          `}
          >
